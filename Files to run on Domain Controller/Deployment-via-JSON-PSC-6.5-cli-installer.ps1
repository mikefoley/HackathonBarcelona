...
$ConfigLoc = "C:\Users\Administrator\Dropbox\My Code Library\vLab Deployment\PSC_first_instance_on_VC.json"
$Installer = "F:\vcsa-cli-installer\win32\vcsa-deploy.exe"
$UpdatedConfig = "c:\temp\PSC.configuration-readyto-deploy.json"
...
$json."target.vcsa".appliance.name="NAT-2 PSC 01"



# Networking
$json."target.vcsa".network."system.name" = "mgt-psc-01.lab1.local"
$json."target.vcsa".network.mode = "static"
$json."target.vcsa".network.ip = "192.168.1.12"
...
Copy-Item $UpdatedConfig $CodeLibrary
